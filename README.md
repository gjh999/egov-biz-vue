...
전자정부표준프레임워크(eGovFrame) 5.0 기반 **기업 업무 템플릿** 의 Vue 3 프론트엔드입니다.
...
| **egov-biz-vue** (이 저장소) | Vue 3 프론트 | 23001 |
| [egov-biz-react](https://github.com/gjh999/egov-biz-react) | React 19 프론트 (짝) | 23000 |
...
```bash
npm install
npm run dev     # http://localhost:23001
```
...
```bash
docker build -t egov-biz-vue:latest .
docker run --rm -p 23001:8080 -e BACKEND_URL=http://host.docker.internal:28090 egov-biz-vue:latest
```
